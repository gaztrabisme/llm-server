...
| 010 | 2026-02-28 | Build | Post-Unsloth validation: reverse KV (bad), HumanEval 76.2%, tool calling works, PPL methodology sound, UD-Q4_K_XL current | Complete |
| 011 | 2026-03-01 | Build | Community Benchmark Suite: Missing flags, native llama-server support, PP visibility, hardware fingerprint. E1: fit-ctx equivalent to -c. E2: fit-target 1536 for vision. Speed regression found (~75→~50 tok/s, unexplained). Q4_K_M confirmed always Unsloth's (not bartowski's) | Complete |
