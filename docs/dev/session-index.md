...
| 008 | 2026-02-28 | Build | Extended validation: context 65k-262k (KV free lunch confirmed), --no-kv-offload (-63% TG), AesSedai Q4_K_M (KLD 0.0095, best quality), lm-eval (echo=true bug, thinking chain truncation, PPL/KLD > task evals) | In Progress (Phase E pending) |
